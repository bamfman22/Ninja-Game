...
//remove near method to check for collisions
bool ParticleSystem::removeNear(const ofVec3f point, float dist) {
...
void ImpulseRadialForce::updateForce(Particle * particle) {
	...
	//
	ofVec3f dir = ofVec3f(ofRandom(-1, 1), height, ofRandom(-1, 1));
